      ...
      <ThemedCard>
        <SectionList
          ...
          renderSectionHeader={({ section }) => (
            <ThemedText
              type="h1"
              className="bg-light-background dark:bg-dark-background p-2 rounded-2xl mt-8"
            >
              {section.title}
            </ThemedText>
          )}
          ...
          ListFooterComponent={() => (
            <ThemedText
              type="h1"
              className="font-bold bg-light-background dark:bg-dark-background rounded-2xl mb-10 pb-2"
            >
